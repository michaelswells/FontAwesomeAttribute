...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// ArrowAltFromRight unicode value ("fa-arrow-alt-from-right").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/arrow-alt-from-right
        /// </summary>
        public const string ArrowAltFromRight = "fa-arrow-alt-from-right";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/arrow-alt-from-right
        /// </summary>
        public const string ArrowAltFromRight = "ArrowAltFromRight";
    }
}