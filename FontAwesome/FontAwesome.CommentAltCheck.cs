...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// CommentAltCheck unicode value ("fa-comment-alt-check").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/comment-alt-check
        /// </summary>
        public const string CommentAltCheck = "fa-comment-alt-check";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/comment-alt-check
        /// </summary>
        public const string CommentAltCheck = "CommentAltCheck";
    }
}