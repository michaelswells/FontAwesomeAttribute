...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// CommentAltPlus unicode value ("fa-comment-alt-plus").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/comment-alt-plus
        /// </summary>
        public const string CommentAltPlus = "fa-comment-alt-plus";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/comment-alt-plus
        /// </summary>
        public const string CommentAltPlus = "CommentAltPlus";
    }
}