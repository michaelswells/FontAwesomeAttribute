...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// CommentAltSmile unicode value ("fa-comment-alt-smile").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/comment-alt-smile
        /// </summary>
        public const string CommentAltSmile = "fa-comment-alt-smile";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/comment-alt-smile
        /// </summary>
        public const string CommentAltSmile = "CommentAltSmile";
    }
}