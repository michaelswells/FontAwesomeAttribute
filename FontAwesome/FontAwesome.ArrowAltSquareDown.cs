...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// ArrowAltSquareDown unicode value ("fa-arrow-alt-square-down").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/arrow-alt-square-down
        /// </summary>
        public const string ArrowAltSquareDown = "fa-arrow-alt-square-down";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/arrow-alt-square-down
        /// </summary>
        public const string ArrowAltSquareDown = "ArrowAltSquareDown";
    }
}