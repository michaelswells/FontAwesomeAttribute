...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// ArrowFromBottom unicode value ("fa-arrow-from-bottom").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/arrow-from-bottom
        /// </summary>
        public const string ArrowFromBottom = "fa-arrow-from-bottom";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/arrow-from-bottom
        /// </summary>
        public const string ArrowFromBottom = "ArrowFromBottom";
    }
}