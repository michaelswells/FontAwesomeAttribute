...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// TrafficLightSlow unicode value ("fa-traffic-light-slow").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/traffic-light-slow
        /// </summary>
        public const string TrafficLightSlow = "fa-traffic-light-slow";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/traffic-light-slow
        /// </summary>
        public const string TrafficLightSlow = "TrafficLightSlow";
    }
}