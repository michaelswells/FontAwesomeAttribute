...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// SortSizeDownAlt unicode value ("fa-sort-size-down-alt").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/sort-size-down-alt
        /// </summary>
        public const string SortSizeDownAlt = "fa-sort-size-down-alt";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/sort-size-down-alt
        /// </summary>
        public const string SortSizeDownAlt = "SortSizeDownAlt";
    }
}