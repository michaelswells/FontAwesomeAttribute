...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// MobileAndroidAlt unicode value ("fa-mobile-android-alt").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/mobile-android-alt
        /// </summary>
        public const string MobileAndroidAlt = "fa-mobile-android-alt";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/mobile-android-alt
        /// </summary>
        public const string MobileAndroidAlt = "MobileAndroidAlt";
    }
}