...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// CreditCardFront unicode value ("fa-credit-card-front").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/credit-card-front
        /// </summary>
        public const string CreditCardFront = "fa-credit-card-front";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/credit-card-front
        /// </summary>
        public const string CreditCardFront = "CreditCardFront";
    }
}