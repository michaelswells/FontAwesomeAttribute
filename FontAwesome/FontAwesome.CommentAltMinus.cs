...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// CommentAltMinus unicode value ("fa-comment-alt-minus").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/comment-alt-minus
        /// </summary>
        public const string CommentAltMinus = "fa-comment-alt-minus";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/comment-alt-minus
        /// </summary>
        public const string CommentAltMinus = "CommentAltMinus";
    }
}