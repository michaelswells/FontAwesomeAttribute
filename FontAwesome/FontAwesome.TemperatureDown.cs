...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// TemperatureDown unicode value ("fa-temperature-down").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/temperature-down
        /// </summary>
        public const string TemperatureDown = "fa-temperature-down";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/temperature-down
        /// </summary>
        public const string TemperatureDown = "TemperatureDown";
    }
}