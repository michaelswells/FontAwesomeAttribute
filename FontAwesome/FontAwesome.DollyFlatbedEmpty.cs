...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// DollyFlatbedEmpty unicode value ("fa-dolly-flatbed-empty").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/dolly-flatbed-empty
        /// </summary>
        public const string DollyFlatbedEmpty = "fa-dolly-flatbed-empty";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/dolly-flatbed-empty
        /// </summary>
        public const string DollyFlatbedEmpty = "DollyFlatbedEmpty";
    }
}