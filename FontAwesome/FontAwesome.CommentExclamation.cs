...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// CommentExclamation unicode value ("fa-comment-exclamation").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/comment-exclamation
        /// </summary>
        public const string CommentExclamation = "fa-comment-exclamation";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/comment-exclamation
        /// </summary>
        public const string CommentExclamation = "CommentExclamation";
    }
}