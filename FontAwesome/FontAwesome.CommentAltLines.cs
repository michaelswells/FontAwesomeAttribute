...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// CommentAltLines unicode value ("fa-comment-alt-lines").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/comment-alt-lines
        /// </summary>
        public const string CommentAltLines = "fa-comment-alt-lines";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/comment-alt-lines
        /// </summary>
        public const string CommentAltLines = "CommentAltLines";
    }
}