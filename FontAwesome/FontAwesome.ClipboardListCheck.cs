...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// ClipboardListCheck unicode value ("fa-clipboard-list-check").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/clipboard-list-check
        /// </summary>
        public const string ClipboardListCheck = "fa-clipboard-list-check";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/clipboard-list-check
        /// </summary>
        public const string ClipboardListCheck = "ClipboardListCheck";
    }
}