...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// MonitorHeartRate unicode value ("fa-monitor-heart-rate").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/monitor-heart-rate
        /// </summary>
        public const string MonitorHeartRate = "fa-monitor-heart-rate";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/monitor-heart-rate
        /// </summary>
        public const string MonitorHeartRate = "MonitorHeartRate";
    }
}