...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// MapMarkerSmile unicode value ("fa-map-marker-smile").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/map-marker-smile
        /// </summary>
        public const string MapMarkerSmile = "fa-map-marker-smile";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/map-marker-smile
        /// </summary>
        public const string MapMarkerSmile = "MapMarkerSmile";
    }
}