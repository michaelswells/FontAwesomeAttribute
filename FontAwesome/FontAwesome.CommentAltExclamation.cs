...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// CommentAltExclamation unicode value ("fa-comment-alt-exclamation").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/comment-alt-exclamation
        /// </summary>
        public const string CommentAltExclamation = "fa-comment-alt-exclamation";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/comment-alt-exclamation
        /// </summary>
        public const string CommentAltExclamation = "CommentAltExclamation";
    }
}