...
namespace FontAwesome
{
    ...
    {
        /// <summary>
        /// MapMarkerExclamation unicode value ("fa-map-marker-exclamation").
        /// <para/>
        /// This icon supports the following styles: Light (Pro), Regular (Pro), Solid (Pro), Duotone (Pro)
        /// <para/>
        /// See https://fontawesome.com/icons/map-marker-exclamation
        /// </summary>
        public const string MapMarkerExclamation = "fa-map-marker-exclamation";
    }
    ...
    public static partial class Icon
    {
        ...
        /// See https://fontawesome.com/icons/map-marker-exclamation
        /// </summary>
        public const string MapMarkerExclamation = "MapMarkerExclamation";
    }
}